...
function video(withVideoCallback, metadata = {}) {
    const value = { readyState: 1, paused: false, currentTime: 0, videoWidth: 2, videoHeight: 2, dataset: { ...metadata }, play: async () => { }, pause() { this.paused = true; }, addEventListener() { }, removeEventListener() { } };
...
const source = video(true, { fps: "10" });
const target = {
    requestAnimationFrame() { throw new Error("fallback should not be used"); }, cancelAnimationFrame() { }, Audio: class {
        constructor() { this.currentTime = 0; this.played = false; }
        play() { this.played = true; return Promise.resolve(); }
    }
};
const instance = new PreviewController({ video: source, width: 2, height: 2, frameCount: 8, windowTarget: target });
instance.previewWindow = { closed: false, close() { this.closed = true; } };
instance.previewCanvas = { width: 420, height: 420 };
instance.previewContext = context();
instance.previewCounter = { textContent: "" };
